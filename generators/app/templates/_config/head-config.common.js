...
module.exports = {
  link: [
    ...
    // {rel: 'icon', type: 'image/png', sizes: '32x32', href: 'assets/img/app/favicon_90x90.png'},
    // {rel: 'icon', type: 'image/png', sizes: '96x96', href: 'assets/img/app/favicon_90x90.png'},
    // {rel: 'icon', type: 'image/png', sizes: '16x16', href: 'assets/img/app/favicon_90x90.png'}
  ],
  meta: [
