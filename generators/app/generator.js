...
module.exports = class MainGenerator {
  ...
  sayHello() {
    this.wrapper.log(
      yosay('Welcome to the ' + chalk.red('Multiple page application Webpack Generator')));
  }
  ...
  writing() {
    ...
    for (let i in tpls) {
      if (Object.prototype.hasOwnProperty.call(tpls, i)) {
        this.wrapper.fs.copyTpl(
          this.wrapper.templatePath(i),
          this.wrapper.destinationPath(tpls[i]),
          {
            app: _app.app,
